...
public class Cono extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtLado1=findViewById(R.id.txtRdioCono);
        txtLado2=findViewById(R.id.txtAlturaCono);
    }
    public void calcular(View v){
        ...
        Double resultado=Calculos.volumenCono(ladoUno,ladoDos);
            ...
            if(txtLado2.getText().equals("")){
                ...
                if(Double.parseDouble(txtLado1.getText().toString())<0){
                    ...
                    if(Double.parseDouble(txtLado2.getText().toString())<0){
                        ...
                        Operaciones O = new Operaciones(getResources().getString(R.string.volumen_con),getResources().getString(R.string.radio)+": "+ladoUno+"\n"+
